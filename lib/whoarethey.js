...
class WhoAreThey {
    ...
    * generateTransactions(accounts, filter) {
    ...
    accountExists(site, response) {
        ...
        const aec = !account_existence_code ? false : this.getArray(account_existence_code)
        const aes = !account_existence_string ? false : this.getArray(account_existence_string)

        const amc = !account_missing_code ? false : this.getArray(account_missing_code)
        const ams = !account_missing_string ? false : this.getArray(account_missing_string)
